...
| W3 | Read and graph (N8–N10) | scanned or photographed papers | marked answers, mistake patterns, the child's skill graph | **gate 1 closed 2026-09-20: all 16 papers entered and all 71 in-scope scans read.** 49 sittings, 16 of 16 children, 869 answers, 0 failed; 501 settled by the engine and 368 waiting for a person on the approval screen. No child has a ladder yet, by design — the graph reads confirmed evidence only. The reader is at 76.2% against a 97% bar|
