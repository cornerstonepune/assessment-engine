...
| W2 | Assemble and print (N5–N7) | each child's prescription | per-child papers with QR, spares, key; the teacher approves | **← we are here. Week runner, class-need target (ADR 0016), `/week/*` endpoints and F2 built 2026-09-20; the approval gate and a live run remain** |
