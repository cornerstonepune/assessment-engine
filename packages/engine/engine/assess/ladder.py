...
RUNGS = {
    ...
    "R2": dict(
        band="G1",
        skills=["NUM.OPS.01"],
        desc="Adds within 20 (crossing 10); part-part-whole; +1/+10 patterns",
    ),
    "R3": dict(band="G1", skills=["NUM.OPS.02"], desc="Subtracts within 20 as take-away and 'how many more'"),
    "R4": dict(
        band="G2",
        skills=["NUM.OPS.01", "NUM.OPS.02"],
        desc="2-digit ± without regrouping in place-value columns",
    ),
    ...
    "R7": dict(
        band="G2",
        skills=["NUM.OPS.05"],
        desc="Mental strategies: bridging, friendly numbers, missing numbers, equality",
    ),
    "R8": dict(
        band="G2", skills=["NUM.PRB.02", "NUM.MEAS.04"], desc="One- and two-step word problems in ₹ / objects"
    ),
    ...
    "R11": dict(
        band="G3",
        skills=["NUM.PV.03", "NUM.PRB.03"],
        desc="Estimate first (round to 10), judge reasonableness",
    ),
    "R12": dict(
        band="G4",
        skills=["NUM.OPS.01", "NUM.OPS.02"],
        desc="4-digit addition with multiple addends; 4-digit subtraction across zeros",
    ),
    "R13": dict(
        band="G4",
        skills=["NUM.OPS.05", "NUM.PRB.03"],
        desc="Chooses an efficient strategy; place-value reasoning under constraint",
    ),
    "R14": dict(
        band="G4",
        skills=["NUM.PRB.02", "NUM.MEAS.04"],
        desc="Multi-step ₹ problems under a budget constraint",
    ),
